...
new_list = [] 
# wheelchair accesible in toronto  can fit 150 + store in list 
for data in venues: 
    if data['city'] == 'Toronto' and data['wheelchair_accessible'] == True and data['capacity'] >= 150: 
        new_list.append(data['address'])
print(new_list)
